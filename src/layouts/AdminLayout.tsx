                ...
                {hasAccess('Master Data') && (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-48">
                      ...
                      <DropdownMenuItem render={<Link to="/admin/units" className="w-full cursor-pointer" />}>
                        Unit Layanan
                      </DropdownMenuItem>
                    ...
                    {hasAccess('Master Data') && (
                      <>
                        <DropdownMenuGroup>
                          ...
                          <DropdownMenuItem render={<Link to="/admin/units" className="w-full cursor-pointer pl-6" />}>Unit Layanan</DropdownMenuItem>
